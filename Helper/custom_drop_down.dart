...
class _DropdownRoute<T> extends PopupRoute<_DropdownRouteResult<T>> {
  ...
  _MenuLimits getMenuLimits(Rect buttonRect, double availableHeight, int index) {
    ...
    final double selectedItemOffset = -42.0;
...
class CustomDropdownButton<T> extends StatefulWidget {
  ...
  /// The left padding of the menu.
  final double menuPaddingLeft;

  /// The right padding of the menu.
...
class _DropdownButtonState<T> extends State<CustomDropdownButton<T>> with WidgetsBindingObserver {
  ...
  void _handleTap() {
    ...
    final TextDirection textDirection = Directionality.of(context);
    final EdgeInsets menuMargin = EdgeInsets.only(left: widget.menuPaddingLeft ?? 0, right: widget.menuPaddingRight ?? 0 );
    ...
    _dropdownRoute = _DropdownRoute<T>(
      ...
      padding: menuMargin.resolve(textDirection),
...
class CustomDropdownButtonFormField<T> extends FormField<T> {
  ...
  CustomDropdownButtonFormField({
    ...
    double menuPaddingLeft,
    double menuPaddingRight,
  }) : assert(items == null || items.isEmpty || value == null ||
      items.where((CustomDropdownMenuItem<T> item) {
        return item.value == value;
      }).length == 1,
              ...
              return InputDecorator(
                ...
                child: CustomDropdownButtonHideUnderline(
                  child: CustomDropdownButton<T>(
                    ...
                    menuPaddingRight: menuPaddingRight,
                  ),
                ),
              );
            }),
